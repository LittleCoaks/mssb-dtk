#ifndef __GAME_CAMERA_CAMERA_H_
#define __GAME_CAMERA_CAMERA_H_
...
int fn_3_164A8(void);
BOOL fn_3_1650C(int* outX, int* outY, BOOL r5, f32 pX, f32 pY, f32 pZ);
