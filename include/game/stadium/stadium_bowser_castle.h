...
void fn_3_C1C18(struct _CastleCameraSlot* slot);
...
void fn_3_C2C80(struct _CastleSparkParticle* p, StadiumLink* link);
void fn_3_C2EDC(struct _CastleFlameParticle* p);
BOOL fn_3_C30F0(struct _CastleFlameEmitter* emitter);
...
void fn_3_C444C(struct _CastleFireballEmitter* handle, StadiumObject* obj);
BOOL fn_3_C4724(struct _CastleSparkEmitter* emitter);
void fn_3_C48D0(struct _CastleFireballEmitter* handle, Vec pos);
void fn_3_C4B80(void);
void fn_3_C4CF4(struct _CastleFlameEmitter* emitter, u8 group);
BOOL fn_3_C4F00(struct _CastleFireballEmitter* handle);
...
void flameControl(struct _CastleFireObj* fire);
...
void fn_3_C77AC(struct _CastleFireballEmitter* handle, StadiumObject* obj);
void thwomp_slamControl(struct _CastleThwompObj* thwomp);
