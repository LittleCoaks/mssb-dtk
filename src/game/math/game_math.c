...
s16 calculateDiffInAngles(f32 x, f32 y) {
    f32 diff = x - y;
    int ang;
    if (diff < 0) {
        diff = -diff;
...
f32 calculateBallInterceptDistance(VecXYZ* l_start, VecXYZ* l_end, VecXYZ* point, VecXYZ* outClosest) {
    // r6 = r31
    // r5 = r30
    // r4 = r29
    // r3 = r28
